...
000011 01 score1.
000012    03 score OCCURS 1000 DEPENDING N.
000013       05 num  PIC 9(10).
000014       05 A    PIC 9(10).
000015       05 B    PIC 9(10).
000016       05 AB   PIC 9(10).
000017       05 pass PIC 9(1) VALUE ZERO.
000018 01 i          PIC 9(10) COMP.
000019 01 ln         PIC X(4000).
000020 01 pt         PIC S9(10).
