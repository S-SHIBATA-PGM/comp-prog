...
01 h_a        PIC X(4) VALUE X"00000000".
01 h_b        PIC X(4) VALUE X"00000000".
...
PROCEDURE DIVISION.
  ACCEPT ln.
  UNSTRING ln DELIMITED SPACE INTO VAL_A VAL_B.
  *> 外部データ
  ...
  *> 10進数 を 16進数 に変換
  CALL "DCM_TO_HEX" USING BY CONTENT VAL_A
                          BY REFERENCE h_a.
*>   CALL "DCM_TO_HEX" USING BY CONTENT VAL_B
*>                           BY REFERENCE h_b.
*>   CALL "CBL_XOR" USING h_a, h_b, BY VALUE 4.
  *> 16進数 を 2進数、10進数 に変換
*>   CALL "HEX_TO_OTHER" USING BY CONTENT h_b
  CALL "HEX_TO_OTHER" USING BY CONTENT h_a
                            BY REFERENCE b_txt
                            BY REFERENCE d_num
                            BY REFERENCE h_txt.
*>   MOVE d_num TO zs.
