...
FILE SECTION.
FD SYSIN_B.
01 INDATA_B   PIC X(2200011).
FD SYSIN_S.
01 INDATA_S   PIC X(22011).
...
01 i          PIC 9(10) COMP.
01 idx1.
   03 idx     PIC 9(10) OCCURS 200000 DEPENDING N.
01 ix         PIC 9(10) COMP VALUE 1.
01 j          PIC 9(10) COMP.
01 ln         PIC X(30).
01 pt         PIC S9(10).
01 s          PIC 9(10).
...
PROCEDURE DIVISION.
  ...
  PERFORM VARYING i FROM 1 BY 1 UNTIL N < i
    ...
    PERFORM VARYING j FROM 1 BY 1 UNTIL L < j
      IF 1000 < N
        UNSTRING INDATA_S DELIMITED SPACE INTO A(ix + j - 1) POINTER pt
      ELSE
        UNSTRING INDATA_B DELIMITED SPACE INTO A(ix + j - 1) POINTER pt
      END-IF
    END-PERFORM
    ADD L TO ix
  END-PERFORM.
